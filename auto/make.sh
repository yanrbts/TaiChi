...
mkdir -p $TCH_OBJS/src/core \
         $TCH_OBJS/src/fmq \
         $TCH_OBJS/src/os/unix
...
binary:	$TCH_OBJS${tch_dirsep}taichi$tch_binext

$TCH_OBJS${tch_dirsep}taichi$tch_binext: $tch_deps$tch_spacer
	\$(LINK) $tch_long_start$tch_binout$TCH_OBJS${tch_dirsep}taichi$tch_binext$tch_long_cont$tch_objs$TCH_LIB
	$tch_rcc
$tch_long_end
